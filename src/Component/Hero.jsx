...
import { Github, Mail, Linkedin, Terminal, Zap, Code2 } from 'lucide-react'; // Added Code2 icon
      ...
      <div className={`max-w-6xl mx-auto text-center transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
        <div className="mb-8 relative">
          <div className="w-40 h-40 rounded-full bg-gradient-to-br from-cyan-500 via-blue-500 to-purple-600 mx-auto mb-6 flex items-center justify-center relative overflow-hidden group animate-float">
            ...
            <div className="absolute inset-0 border-4 border-purple-400/30 rounded-full animate-ping" style={{ animationDelay: '0.5s' }} />
          </div>
        </div>
        ...
        <p className="text-xl md:text-3xl text-gray-300 mb-8 font-light animate-fadeIn" style={{ animationDelay: '0.3s' }}>
          Ready to contribute <span className="text-cyan-400 font-semibold animate-glow">robust code</span> across the entire {' '}
          <span className="text-purple-400 font-semibold animate-glow" style={{ animationDelay: '0.5s' }}>development</span> lifecycle.
        </p>
        
        <div className="flex gap-6 justify-center mb-12 animate-fadeIn" style={{ animationDelay: '0.5s' }}>
          {[
            { icon: Github, href: 'https://github.com/ShrivastavaAyush1611', color: 'cyan' },
            { icon: Mail, href: 'mailto:ayushshrivastava16012005@gmail.com', color: 'purple' },
            { icon: Linkedin, href: 'https://www.linkedin.com/in/ayushshri1611/', color: 'blue' }
          ].map((social, idx) => (
            <a
              key={idx}
              href={social.href}
        ...
        <div className="inline-block animate-bounceIn" style={{ animationDelay: '0.7s' }}>
          <button 
